...
public class Balance_On_Station extends CommandBase {
  ...
  public void initialize() {
    ...
    drivetrain.drive(-2, 0, 0, false);// TODO: move forward fast using the drive() method
  }
  ...
  public void execute() {
    ...
    if(moving_fast == true && drivetrain.pitchAngle() >= 20) {
  ...
  public void end(boolean interrupted) {
    ...
    (new Drivetrain_XStance()).schedule();
  }
  ...
  public boolean isFinished() {
    ...
    return !moving_fast && drivetrain.pitchAngle() <= 15; // TODO: This should be "return !moving_fast && drivetrain.getPitch() <= some number"
  }
}