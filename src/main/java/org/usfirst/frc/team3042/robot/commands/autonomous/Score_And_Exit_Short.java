...
public class Score_And_Exit_Short extends SequentialCommandGroup {

  public Score_And_Exit_Short(double rotationGoal, double extensionGoal) {
    ParallelCommandGroup leaveZone = new ParallelCommandGroup(new Drivetrain_GyroStraight(1, -0.9, 0), new Arm_SetPosition(RobotMap.kArmDrivePosition, RobotMap.kExtendDrivePosition));
